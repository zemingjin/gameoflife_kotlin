...
class Paint(private val panel: JPanel) {
    ...
    private val fillCell: (Graphics) -> (Int) -> (Int) -> Unit = { graphics ->
        { y ->
            { x ->
    ...
    private val drawBorder: (Graphics) -> (Int) -> (Int) -> Unit = { graphics ->
        { y ->
            { x ->
